...
function post(request, response) {
	...
	//var data = JSON.Parse(request.con);
	
	var name = request.body.name; //Retreiving name from request body
	var email = request.body.email;//Retreiving email from Request body
